// Generated by Apple Swift version 5.8 effective-4.2 (swiftlang-5.8.0.124.2 clang-1403.0.22.11.100)
#ifndef FLUTTER_TTS_SWIFT_H
#define FLUTTER_TTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_tts",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11flutter_tts21SwiftFlutterTtsPlugin")
@interface SwiftFlutterTtsPlugin : NSObject <AVSpeechSynthesizerDelegate, FlutterPlugin>
